...
bot.command('help', (ctx) => {
    const helpMsg = `
🌌 *OmniMind OS Node Bot - دليل الميزات الأسطورية*

🔥 *فهرس القدرات الفائقة الـ 300:*
• \`/features\` - فتح المستكشف التفاعلي لتصفح فئات وقدرات النظام الـ 300.
• \`/feature [الرقم]\` - تفعيل الميزة رقم (1-300) فوراً (مثال: \`/feature 53\` لتفعيل مراجعة الأمان).
• \`/feature [الاسم]\` - البحث السريع في الـ 300 ميزة وتنشيطها تلقائياً.

🤖 *التحكم الأساسي والشخصيات (/persona):*
• /task [مهمة] - تشغيل العميل الذكي لتنفيذ مهمة برمجية.
• /persona [normal|duck|devil|eli5|roast] - تغيير شخصية البوت للتفاعل المناسب.
  - 🦆 *duck:* البطة المطاطية التفاعلية - إرشاد سقراطي بدون تقديم كود مباشر.
  - 😈 *devil:* محامي الشيطان - الاعتراض على قراراتك وتحليل العيوب.
  - 🧸 *eli5:* شرح الكود للأطفال بتبسيط وتشبيهات رائعة.
  - 🔥 *roast:* شوي لطيف بأسلوب كوميدي ساخر للمطورين.

🏆 *نظام التلعيب والمرح والإنتاجية:*
...
🏗️ *أدوات التطوير المعمقة والمشاريع:*
...
bot.command('projects', async (ctx) => {
    ...
    if (!text) {
        ...
        return ctx.reply(`📁 *إدارة المشاريع*\n\n• المشروع الحالي النشط: \`${active ? active.name : "لا يوجد مشروع نشط"}\`\n• مسار المجلد: \`${active ? active.project_path : "غير محدد"}\`\n\nلإضافة أو تفعيل مشروع جديد:\n\`/projects [اسم المشروع] [مسار المجلد]\`\n\nمثال:\n\`/projects MyWebSite /app/applet\``, { parse_mode: 'Markdown' });
    }
...
🔥 *فهرس القدرات الفائقة الـ 300:*
• \`/features\` - فتح المستكشف التفاعلي لتصفح فئات وقدرات النظام الـ 300.
• \`/feature [الرقم]\` - تفعيل الميزة رقم (1-300) فوراً.
• \`/feature [الاسم]\` - البحث السريع في الـ 300 ميزة وتنشيطها تلقائياً.
